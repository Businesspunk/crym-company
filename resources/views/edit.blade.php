	...
	<section class="add_choose">
		<div class="container">
			...
			<div class="wrap desc">
				...
				<div class="right">
					<textarea name="description" minlength=20 placeholder="Опишите объявление" rows="10">{{ $post->description }}</textarea>
				</div>
			</div>
			<div class="wrap name">
				<div class="left">Номер телефона</div>
				<div class="right">
					<input required name="phone_number" type="text" value="{{ $post->phone_number }}" placeholder="Номер телефона">
				</div>
			</div>
			<div class="wrap name">
